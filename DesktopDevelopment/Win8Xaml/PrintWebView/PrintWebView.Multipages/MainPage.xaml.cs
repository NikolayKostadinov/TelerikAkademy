...
namespace PrintWebView.Multipages
{
    /// <summary>
    ...
    public sealed partial class MainPage : Page
    {
        ...
        {
            MyWebViewRectangle.Fill = GetWebViewBrush(mainWebView);
            MyPrintPages.ItemsSource = GetWebPages(mainWebView, new Windows.Foundation.Size(100d, 150d));
            mainWebView.Visibility = Windows.UI.Xaml.Visibility.Visible;
        }

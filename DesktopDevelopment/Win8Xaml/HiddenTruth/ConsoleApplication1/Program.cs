...
namespace BloggerDevSample
{
    class ConsoleSample
    {
        ...
        static void Main(string[] args)
        {
            ...
            string username = "saykor@saykor.com";
            string password = "radiana85";//"/E1kWEm2/kVoJY";
            //if (args.Length != 2)
            //{
            ...
            Uri blogPostUri = new Uri("https://www.blogger.com/feeds/4948284982773980428/posts/default");// SelectUserBlog(service); //new Uri("https://www.blogger.com/feeds/7485604791378022116/posts/default");// 

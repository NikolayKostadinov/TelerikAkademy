...
{
    public class PrintService_old : Page, IPrintService
    {
        #region properties
        ...
        private Canvas PrintingRoot
        {
            get
            {
                ...
                return _printingRoot;//this.callingPage.FindName("printingRoot") as Canvas;
            }
        }
        ...
        {
            PrintTask printTask = e.Request.CreatePrintTask("C# Printing SDK Sample", sourceRequested => sourceRequested.SetSource(printDocumentSource));
        }

        /// <summary>
        /// This function registers the app for printing with Windows and sets up the necessary event handlers for the print process.
        /// </summary>
        public void RegisterForPrinting(ItemViewModel itemViewModel)
        {
        ...
        public async void Print()
        {
            ...
            // Don't act when in snapped mode: the charm is larger than the app.
            if (ApplicationView.Value != ApplicationViewState.Snapped)
            {
                ...
                try
                {
                    ...
                    this.OnStatusChanged(new PrintServiceEventArgs("")); // Print charm open, but there's no close event handler
                }
                catch (Exception)
                {
        ...
        private RichTextBlockOverflow AddOnePrintPreviewPage(RichTextBlockOverflow lastRTBOAdded, PrintPageDescription printPageDescription)
        {
            ...
            if (isFirstPage)
            {
                ...
                if (ShowText)
                {
                    ...
                    rtbl.SetValue(Grid.ColumnSpanProperty, 2);
        ...
        private RichTextBlock AddContentToRTBl(RichTextBlock rtbl)
        {
            ...
            Run run = new Run();
            run.Text = _itemViewModel.SelectedItem.Content;

...
{
    public class PrintService : Page
    {
        /// <summary>
        ...
        /// <summary>
        /// The percent of margin width, content is set at 85% (0.85) of the page's width
        /// </summary>
        private double HorizontalPrintMargin = 0.075;

        /// <summary>
        /// The percent of margin height, content is set at 94% (0.94) of tha page's height
        /// </summary>
        ...
        /// </summary>
        public void RegisterForPrinting(object sourcePage, Type printPageType, object viewModel)
        {
            this.callingPage = sourcePage as Page;
